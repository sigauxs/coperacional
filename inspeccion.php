                    ...
                    <form action="./server/inspeccion-server.php" method="POST" class="needs-validation" novalidate>
                        ...
                        <div class="mb-3 mt-5 row">
                            <div class="col-sm-12 mb-3">
                                <input type="date" name="fechaInspeccion" id="fechaInspeccion" class="form-control">
                            </div>
                        </div>
                        <div class="mb-3 row">
                            <div class="col-sm-12 mb-3">
                                <textarea name="descripcion_inspeccion" id="descripcionInspeccion" cols="30" rows="5"></textarea>
